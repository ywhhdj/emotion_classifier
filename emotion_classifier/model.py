...
class ModelConfig:
    GITHUB_REPO = "https://github.com/ywhhdj/emotion_classifier.git"
    GITHUB_TAG  = "v0.1.0"
    ...
    CHECKSUMS = {
        "emotion-classify.pt": "sha256:d8e3c69a2d50f8c65100f4ca88aacbff4756410801f5da788850a7aa0d46b39d",
    ...
    def download_url(cls, filename: str) -> str:
        return (
            f"{cls.GITHUB_REPO}/releases/tag/"
